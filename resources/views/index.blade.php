			...
			<div class="row m-auto">
				<div class="col-4">
					<div class="animImageContainer w-100">
						<div data-count="0" class="slide-image active" style="background-image: url({{ asset("images/products/hairclinic_image.png") }});"></div>
						<div data-count="1" class="slide-image" style="background-image: url({{ asset("images/products/hairclinic_image.png") }});"></div>
						<div data-count="2" class="slide-image" style="background-image: url({{ asset("images/products/hairclinic_image.png") }});"></div>
					</div>
				</div>
				<div class="col-4">
					<div class="animImageContainer" style="width:400px;">
						<img data-count="0" class="packshot w-100 active" src="{{ asset("images/packshot.png") }}">
						<img data-count="1" class="packshot w-100" src="{{ asset("images/packshot.png") }}">
						<img data-count="2" class="packshot w-100" src="{{ asset("images/packshot.png") }}">
					</div>
				</div>
				<div class="col-4">
					...
					<button class="circleButton">Ismertető</button>
				</div>
			</div>
		</div>
	</section>
