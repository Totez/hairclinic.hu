                ...
                <div class="col-12">
                    <div class="container">
                        <div class="row" id="product-nav-content">
                            ...
                            <div class="col-4">
                                <img class="w-100 triggerFadeIn" src="{{ asset("images/packshot-hairclinic-men.png") }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row" style="height:33vh">
                        <div class="col-12">
                            <div class="hc-product-title" style="margin-top:11vh;">
                                ...
                                <h1 class="product-type triggerFadeIn">Men</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-8">
                            <img src="{{ asset('images/slide_image_men.png') }}" class="product-image triggerFadeIn">
                        </div>
                    </div>
...
{{--                                    <h6 class="text-green mt-5 font-weight-light" style="margin-bottom:35px;">30 kapszula</h6>--}}
                                    ...
                                    {{-- rossmann --}}
                                    <a href="{{ $products["rossmann_hc_men"]["url"] }}" target="blank" style="text-decoration: none;">
                                        <div class="row border-green px-1 py-3 align-items-center my-4 hc-hover mx-auto mx-md-0 position-relative">
                                            ...
                                            <div class="col-4 justify-content-end align-items-center d-flex">
                                                <span class="text-md text-dark">{{ number_format($products["rossmann_hc_men"]["price"], 0, ",", " ") }}.-</span>
                                            </div>
                                            @if($products["rossmann_hc_men"]["is_outdated"])
                                                <span class="position-absolute text-green" style="bottom:0px;right:1rem;font-size:0.55rem;">Utolsó frissítés: {{ $products["rossmann_hc_men"]["updated_at"]->format("Y-m-d") }}</span>
                                            @endif
                                        </div>
                                    </a>

                                    {{-- dm --}}
                                    <a href="{{ $products["dm_hc_men"]["url"] }}" target="blank" style="text-decoration: none;">
                                        <div class="row border-green px-1 py-3 align-items-center my-4 hc-hover mx-auto mx-md-0 position-relative">
                                            <div class="col-7">
                                            ...
                                            <div class="col-4 justify-content-end align-items-center d-flex">
                                                <span class="text-md text-dark">{{ number_format($products["dm_hc_men"]["price"], 0, ",", " ") }}.-</span>
                                            </div>
                                            @if($products["dm_hc_men"]["is_outdated"])
                                                <span class="position-absolute text-green" style="bottom:0px;right:1rem;font-size:0.55rem;">Utolsó frissítés: {{ $products["dm_hc_men"]["updated_at"]->format("Y-m-d") }}</span>
                                            @endif
                                        </div>
                                    </a>
